<?php 
    ...
    if($_POST) {
        ...
        $to = "remy.rabischung@laplateforme.io"; // Votre adresse email
        ...
        $count = $pdo->exec("INSERT INTO contact (id_member, first_name, last_name, email, phone_number, motive, message, date_message)
        VALUES('$_POST[id_member]', '$_POST[first_name]', '$_POST[last_name]', '$_POST[email]', '$_POST[phone_number]', '$_POST[motive]', '$_POST[message]', NOW() )");
